...
//var jsdom          = require("jsdom-jscore").jsdom;
...
(function (callback) {
     ...
     *  > };
        ...
        serialize: function (elem)
        {
            ...
            if (typeof(elem.tree) === "function" && elem.getAttribute("_realname")) {
    ...
    Strophe.Request.prototype = {
        ...
        getResponse: function ()
        {
            ...
            if (this.xhr.responseXML && this.xhr.responseXML.documentElement) {
                ...
                node = this.xhr.responseText;
                Strophe.error("invalid response received");
                Strophe.error("responseText: " + this.xhr.responseText);
                Strophe.error("responseXML: " + this.xhr.responseXML);
                //Strophe.serialize(this.xhr.responseXML));
            }
     ...
     *  > };
        ...
        _connect_cb: function (req)
        {
            ...
            var typ = typeof(bodyWrap) === "function"? bodyWrap.getAttribute("type"): null;
            var cond, conflict;
            if (typ !== null && typ == "terminate") {
                // an error occurred
            ...
            if (!this.sid && typeof(bodyWrap) === "function") {
                this.sid = bodyWrap.getAttribute("sid");
            }
            if (!this.stream_id && typeof(bodyWrap) === "function") {
                this.stream_id = bodyWrap.getAttribute("authid");
            }
            var wind = typeof(bodyWrap) === "function" ? bodyWrap.getAttribute('requests') : null;
            if (wind) { this.window = parseInt(wind, 10); }
            var hold = typeof(bodyWrap) === "function" ? bodyWrap.getAttribute('hold'): null;
            if (hold) { this.hold = parseInt(hold, 10); }
            var wait = typeof(bodyWrap) === "function" ? bodyWrap.getAttribute('wait'): null;
            ...
            var mechanisms = typeof(bodyWrap) === "function"? bodyWrap.getElementsByTagName("mechanism"): null;
